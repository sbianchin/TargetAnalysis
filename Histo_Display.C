...
void Histo_Display(Int_t run_number=1, Int_t board_number=0, Int_t iflag=0) {   
	...
	// board_number = 10 -> AC (1 - 12)
	// board_number = 11 -> GV (1 - 12)
	// board_number = 12 -> TTC (1 - 12)

	// board_number = 13 -> C_k & C_pi (ONLY TDC[0]) (1 - 14)
	...
	if (!((board_number == 1) || (board_number == 2) || (board_number == 3) || (board_number == 4) || 
		...
		cout << "  " << endl;
		cout << "Please enter a board number between 1 and 14" << endl;
		cout << "  " << endl;
		return;
	}
