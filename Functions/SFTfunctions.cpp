...
using namespace CommonParameters;
...
void Z_all(double phi, double p1, double p2, double p3, double p4) {
    double Z1[16] = {0.};
    double Z2[16] = {0.};
    double Z3[18] = {0.};
    double Z4[18] = {0.};
...
void Z_all_CR(double phi_top, double phi_bot, double p1, double p2, double p3, double p4) {
    ...
    cout << "    N    |============================================|==========================================="
         << endl;
    cout << "         |      Z1        Z2        Z3        Z4      |        Z1        Z2        Z3        Z4   "
         << endl;
    cout << " ========|============================================|==========================================="
         << endl;
    for (int i = 1; i < 16; i++) {
        printf(" n = %2d  |  %8.3f  %8.3f  %8.3f  %8.3f    |    %8.3f  %8.3f  %8.3f  %8.3f\n", i, Z1_top[i], Z2_top[i],
               Z3_top[i], Z4_top[i], Z1_bot[i], Z2_bot[i], Z3_bot[i], Z4_bot[i]);
        //cout << " n = " << i << "  ||   "  << Z1[i] << "  " << Z2[i] << "  " << Z3[i] << "  " << Z4[i] << endl;
        //cout << "" << endl;
    }
...
double calculate_Z_position(double phi, int N, double p, int layer) {
...
double *calculate_min_Z_position(double phi, double p1, double p2, double p3, double p4, double return_array[20],
                                 int iteration_counter, double delta_z[100]) {
...
std::vector<double> Layer_averaging(std::vector<int> p_fibers, int layer) {
    ...
    std::vector<int> p_cluster_index; // Hold the starting index of each cluster.
    std::vector<int> p_cluster_length; // Hold the length of each cluster.
...
std::vector<double> Batch_Layer_averaging(std::vector<int> p_fibers, int layer) {
    ...
    for (std::vector<int>::iterator it = p_fibers.begin(); it != p_fibers.end(); it++) {
        p_hits[*it - 1] = 1;
    }
...
double SFT_print(double ADC_High_SFT_corr[128], int has_TDC_SFT_hit[128], int SFT_channel_to_fiber[128],
    ...
    std::vector<int> layer_1_p_fibers;
    std::vector<int> layer_2_p_fibers;
    std::vector<int> layer_3_p_fibers;
    std::vector<int> layer_4_p_fibers;

    std::vector<double> layer_1_adc;
    std::vector<double> layer_2_adc;
    std::vector<double> layer_3_adc;
    std::vector<double> layer_4_adc;
    ...
    for (int i = 0; i < 128; i++) {
        if (ADC_High_SFT_corr[i] != 0 && has_TDC_SFT_hit[i]) {
            ...
            if (SFT_channel_to_layer[i] == 1) {
                ...
                for (std::vector<int>::iterator it = layer_1_p_fibers.begin(); it != layer_1_p_fibers.end(); it++) {
                ...
                for (std::vector<int>::iterator it = layer_2_p_fibers.begin(); it != layer_2_p_fibers.end(); it++) {
                    if (*it == SFT_channel_to_fiber[i]) {
                        L2_sft_flag = true;
                        break;
                    }
                ...
                for (std::vector<int>::iterator it = layer_3_p_fibers.begin(); it != layer_3_p_fibers.end(); it++) {
                    if (*it == SFT_channel_to_fiber[i]) {
                        L3_sft_flag = true;
                        break;
                    }
                ...
                for (std::vector<int>::iterator it = layer_4_p_fibers.begin(); it != layer_4_p_fibers.end(); it++) {
                    if (*it == SFT_channel_to_fiber[i]) {
                        L4_sft_flag = true;
                        break;
                    }
  ...
  */
    ...
    // pass std::vectors to new p-averaging function. return std::vector<double> of averaged p-fibers.
    // std::vector<double> Layer_averaging(std::vector<int> p_fibers)
    std::vector<double> layer_1_p_fibers_d;
    std::vector<double> layer_2_p_fibers_d;
    std::vector<double> layer_3_p_fibers_d;
    std::vector<double> layer_4_p_fibers_d;
    ...
    // Storage std::vectors
    std::vector<double> z_avgs_arr;
    std::vector<double> delta_z_arr;
    std::vector<double> p1_store_arr;
    std::vector<double> p2_store_arr;
    std::vector<double> p3_store_arr;
    std::vector<double> p4_store_arr;

    std::vector<int> N1_store_arr;
    std::vector<int> N2_store_arr;
    std::vector<int> N3_store_arr;
    std::vector<int> N4_store_arr;

    std::vector<double> z1_store_arr;
    std::vector<double> z2_store_arr;
    std::vector<double> z3_store_arr;
    std::vector<double> z4_store_arr;

    std::vector<int> p1_p2_flag;
    std::vector<int> p3_p4_flag;

    std::vector<int> z1_z2_flag;
    std::vector<int> z3_z4_flag;
    std::vector<int> z1234_flag;
    ...
    if (layer_1_p_fibers_d.size() != 0 && layer_2_p_fibers_d.size() != 0 && layer_3_p_fibers_d.size() != 0 &&
        layer_4_p_fibers_d.size() != 0) {
        for (std::vector<double>::iterator it_1 = layer_1_p_fibers_d.begin();
             it_1 != layer_1_p_fibers_d.end(); it_1++) {
            for (std::vector<double>::iterator it_2 = layer_2_p_fibers_d.begin();
                 it_2 != layer_2_p_fibers_d.end(); it_2++) {
                for (std::vector<double>::iterator it_3 = layer_3_p_fibers_d.begin();
                     it_3 != layer_3_p_fibers_d.end(); it_3++) {
                    for (std::vector<double>::iterator it_4 = layer_4_p_fibers_d.begin();
                         it_4 != layer_4_p_fibers_d.end(); it_4++) { //
                        ...
                        for (int i = 0; i < NUM_ITERATIONS; i++) {
                            return_array = calculate_min_Z_position(phi, *it_1, *it_2, *it_3, *it_4, array_to_return, i,
                                                                    smallest_delta_z);
    ...
    else if (layer_1_p_fibers_d.size() == 0 && layer_2_p_fibers_d.size() != 0 && layer_3_p_fibers_d.size() != 0 &&
             layer_4_p_fibers_d.size() != 0) {
        for (std::vector<double>::iterator it_2 = layer_2_p_fibers_d.begin();
             it_2 != layer_2_p_fibers_d.end(); it_2++) {
            for (std::vector<double>::iterator it_3 = layer_3_p_fibers_d.begin();
                ...
                for (std::vector<double>::iterator it_4 = layer_4_p_fibers_d.begin();
                    ...
                    for (int i = 0; i < NUM_ITERATIONS; i++) {
                        return_array = calculate_min_Z_position(phi, -1, *it_2, *it_3, *it_4, array_to_return, i,
                                                                smallest_delta_z);
                        smallest_delta_z[i] = *(return_array + 1);
        ...
        for (std::vector<double>::iterator it_1 = layer_1_p_fibers_d.begin();
            ...
            for (std::vector<double>::iterator it_3 = layer_3_p_fibers_d.begin();
                ...
                for (std::vector<double>::iterator it_4 = layer_4_p_fibers_d.begin();
                    ...
                    for (int i = 0; i < NUM_ITERATIONS; i++) {
                        return_array = calculate_min_Z_position(phi, *it_1, -1, *it_3, *it_4, array_to_return, i,
                                                                smallest_delta_z);
                        smallest_delta_z[i] = *(return_array + 1);
        ...
        for (std::vector<double>::iterator it_1 = layer_1_p_fibers_d.begin();
            ...
            for (std::vector<double>::iterator it_2 = layer_2_p_fibers_d.begin();
                ...
                for (std::vector<double>::iterator it_4 = layer_4_p_fibers_d.begin();
                    ...
                    for (int i = 0; i < NUM_ITERATIONS; i++) {
                        return_array = calculate_min_Z_position(phi, *it_1, *it_2, -1, *it_4, array_to_return, i,
                                                                smallest_delta_z);
                        smallest_delta_z[i] = *(return_array + 1);
        ...
        for (std::vector<double>::iterator it_1 = layer_1_p_fibers_d.begin();
            ...
            for (std::vector<double>::iterator it_2 = layer_2_p_fibers_d.begin();
                ...
                for (std::vector<double>::iterator it_3 = layer_3_p_fibers_d.begin();
                    ...
                    for (int i = 0; i < NUM_ITERATIONS; i++) {
                        return_array = calculate_min_Z_position(phi, *it_1, *it_2, *it_3, -1, array_to_return, i,
                                                                smallest_delta_z);
                        smallest_delta_z[i] = *(return_array + 1);
        ...
        for (std::vector<double>::iterator it_2 = layer_2_p_fibers_d.begin();
            ...
            for (std::vector<double>::iterator it_4 = layer_4_p_fibers_d.begin();
                ...
                for (int i = 0; i < NUM_ITERATIONS; i++) {
                    return_array = calculate_min_Z_position(phi, -1, *it_2, -1, *it_4, array_to_return, i,
                                                            smallest_delta_z);
                    smallest_delta_z[i] = *(return_array + 1);
        ...
        for (std::vector<double>::iterator it_2 = layer_2_p_fibers_d.begin();
            ...
            for (std::vector<double>::iterator it_3 = layer_3_p_fibers_d.begin();
                ...
                for (int i = 0; i < NUM_ITERATIONS; i++) {
                    return_array = calculate_min_Z_position(phi, -1, *it_2, *it_3, -1, array_to_return, i,
                                                            smallest_delta_z);
                    smallest_delta_z[i] = *(return_array + 1);
        ...
        for (std::vector<double>::iterator it_1 = layer_1_p_fibers_d.begin();
            ...
            for (std::vector<double>::iterator it_4 = layer_4_p_fibers_d.begin();
                ...
                for (int i = 0; i < NUM_ITERATIONS; i++) {
                    return_array = calculate_min_Z_position(phi, *it_1, -1, -1, *it_4, array_to_return, i,
                                                            smallest_delta_z);
                    smallest_delta_z[i] = *(return_array + 1);
        ...
        for (std::vector<double>::iterator it_1 = layer_1_p_fibers_d.begin();
            ...
            for (std::vector<double>::iterator it_3 = layer_3_p_fibers_d.begin();
                ...
                for (int i = 0; i < NUM_ITERATIONS; i++) {
                    return_array = calculate_min_Z_position(phi, *it_1, -1, *it_3, -1, array_to_return, i,
                                                            smallest_delta_z);
                    smallest_delta_z[i] = *(return_array + 1);
    ...
    std::vector<int> good_delta_z_index;

    std::vector<double> z_avgs_store;
    ...
    if (to_print) {
        cout << "Event #     Angle      L1        L2        L3        L4    ||   Z Avg      Delta Z      Track Length"
             << endl;
        cout << "===========================================================||========================================"
             << endl;
    }

    for (std::vector<int>::iterator it = good_delta_z_index.begin(); it != good_delta_z_index.end(); it++) {
        ...
        if (p1_p2_flag[*it] > 1 && p3_p4_flag[*it] > 1) {
            if (z_avgs_store.empty()) {
                ...
                for (std::vector<double>::iterator db = z_avgs_store.begin(); db != z_avgs_store.end(); db++) {
            ...
            if (to_print) {
                if (fabs(z_avg / double(z_avg_count)) <= 100 && !z_printed) {
                    ...
                    if (p1_store_arr[*it] > 0 && p2_store_arr[*it] > 0 && p3_store_arr[*it] > 0 &&
                        p4_store_arr[*it] > 0) {
                        printf("%-5d   %10.2f   %5.1f     %5.1f     %5.1f     %5.1f   ||\n", evt, phi,
                               p1_store_arr[*it], p2_store_arr[*it],
                        ...
                        cout
                                << "===========================================================||======================================== "
                                << endl;
                    } else if (p1_store_arr[*it] <= 0 && p2_store_arr[*it] > 0 && p3_store_arr[*it] > 0 &&
                               p4_store_arr[*it] > 0) {
                        printf("%-5d   %10.2f %5c       %5.1f     %5.1f     %5.1f   ||\n", evt, phi, '-',
                               p2_store_arr[*it],
                               p3_store_arr[*it], p4_store_arr[*it]);
                        printf("N(i)               %5c     %5d     %5d     %5d     ||\n", '-', N2_store_arr[*it],
                               N3_store_arr[*it], N4_store_arr[*it]);
    ...
    for (std::vector<int>::iterator it = good_delta_z_index.begin(); it != good_delta_z_index.end(); it++) {
        ...
        if (p1_p2_flag[*it] > 1 && p3_p4_flag[*it] > 1) {
            if (ZZ.empty()) {
                ...
                for (std::vector<double>::iterator db = ZZ.begin(); db != ZZ.end(); db++) {
                    if (fabs(*db - z_avg / double(z_avg_count)) < 0.01) {
                        z_printed = true;
                    }
                }
...
void SFT_Ana3(int Run_Number, int evt, double ADC_High_SFT_corr[128], int has_TDC_SFT_hit[128], int SFT_channel_to_fiber[128],
    ...
    std::vector <std::vector<double>> SFT_Z1_top;
    std::vector<double> SFT_Z1_top_col;
    std::vector <std::vector<double>> SFT_Z2_top;
    std::vector<double> SFT_Z2_top_col;
    std::vector <std::vector<double>> SFT_Z3_top;
    std::vector<double> SFT_Z3_top_col;
    std::vector <std::vector<double>> SFT_Z4_top;
    std::vector<double> SFT_Z4_top_col;
    SFT_Z1_top.clear();
    ...
    std::vector <std::vector<double>> SFT_Z1_bottom;
    std::vector<double> SFT_Z1_bottom_col;
    std::vector <std::vector<double>> SFT_Z2_bottom;
    std::vector<double> SFT_Z2_bottom_col;
    std::vector <std::vector<double>> SFT_Z3_bottom;
    std::vector<double> SFT_Z3_bottom_col;
    std::vector <std::vector<double>> SFT_Z4_bottom;
    std::vector<double> SFT_Z4_bottom_col;
    SFT_Z1_bottom.clear();
    ...
    std::vector <std::vector<double>> DZ1_top;
    std::vector<double> DZ1_top_col;
    std::vector <std::vector<double>> DZ2_top;
    std::vector<double> DZ2_top_col;
    std::vector <std::vector<double>> DZ3_top;
    std::vector<double> DZ3_top_col;
    std::vector <std::vector<double>> DZ4_top;
    std::vector<double> DZ4_top_col;
    DZ1_top.clear();
    DZ1_top_col.clear();
    DZ2_top.clear();
    DZ2_top_col.clear();
    ...
    std::vector <std::vector<double>> DZ1_bottom;
    std::vector<double> DZ1_bottom_col;
    std::vector <std::vector<double>> DZ2_bottom;
    std::vector<double> DZ2_bottom_col;
    std::vector <std::vector<double>> DZ3_bottom;
    std::vector<double> DZ3_bottom_col;
    std::vector <std::vector<double>> DZ4_bottom;
    std::vector<double> DZ4_bottom_col;
    DZ1_bottom.clear();
    ...
    std::vector<double> DZ1_lowest_top;
    std::vector<double> DZ1_lowest_bottom;
    std::vector<double> DZ2_lowest_top;
    std::vector<double> DZ2_lowest_bottom;
    std::vector<double> DZ3_lowest_top;
    std::vector<double> DZ3_lowest_bottom;
    std::vector<double> DZ4_lowest_top;
    std::vector<double> DZ4_lowest_bottom;
    DZ1_lowest_top.clear();
    DZ1_lowest_bottom.clear();
    DZ2_lowest_top.clear();
    DZ2_lowest_bottom.clear();
    DZ3_lowest_top.clear();
    DZ3_lowest_bottom.clear();
    DZ4_lowest_top.clear();
    DZ4_lowest_bottom.clear();

    std::vector<int> n1_lowest_top;
    std::vector<int> n1_lowest_bottom;
    std::vector<int> n2_lowest_top;
    std::vector<int> n2_lowest_bottom;
    std::vector<int> n3_lowest_top;
    std::vector<int> n3_lowest_bottom;
    std::vector<int> n4_lowest_top;
    std::vector<int> n4_lowest_bottom;
    n1_lowest_top.clear();
    n1_lowest_bottom.clear();
    n2_lowest_top.clear();
    n2_lowest_bottom.clear();
    n3_lowest_top.clear();
    n3_lowest_bottom.clear();
    n4_lowest_top.clear();
    n4_lowest_bottom.clear();

    std::vector<int> p1_lowest_top;
    std::vector<int> p1_lowest_bottom;
    std::vector<int> p2_lowest_top;
    std::vector<int> p2_lowest_bottom;
    std::vector<int> p3_lowest_top;
    std::vector<int> p3_lowest_bottom;
    std::vector<int> p4_lowest_top;
    std::vector<int> p4_lowest_bottom;
    p1_lowest_top.clear();
    p1_lowest_bottom.clear();
    p2_lowest_top.clear();
    p2_lowest_bottom.clear();
    p3_lowest_top.clear();
    p3_lowest_bottom.clear();
    p4_lowest_top.clear();
    p4_lowest_bottom.clear();

    std::vector<double> Z1_lowest_top;
    std::vector<double> Z1_lowest_bottom;
    std::vector<double> Z2_lowest_top;
    std::vector<double> Z2_lowest_bottom;
    std::vector<double> Z3_lowest_top;
    std::vector<double> Z3_lowest_bottom;
    std::vector<double> Z4_lowest_top;
    std::vector<double> Z4_lowest_bottom;
    Z1_lowest_top.clear();
    Z1_lowest_bottom.clear();
    Z2_lowest_top.clear();
    Z2_lowest_bottom.clear();
    Z3_lowest_top.clear();
    Z3_lowest_bottom.clear();
    Z4_lowest_top.clear();
    Z4_lowest_bottom.clear();


    double lowest_top = 999.;
    double lowest_bottom = 999.;
    int n_lowest_top = 99;
    int n_lowest_bottom = 99;
    double z_lowest_top = 999.;
    double z_lowest_bottom = 999.;
    ...
    */
    ...
    for (unsigned int i1 = 0; i1 < layer_1_p_fibers.size(); i1++)
        layer_1_p_fibers_d.push_back(double(layer_1_p_fibers[i1]));
    for (unsigned int i2 = 0; i2 < layer_2_p_fibers.size(); i2++)
        layer_2_p_fibers_d.push_back(double(layer_2_p_fibers[i2]));
    for (unsigned int i3 = 0; i3 < layer_3_p_fibers.size(); i3++)
        layer_3_p_fibers_d.push_back(double(layer_3_p_fibers[i3]));
    for (unsigned int i4 = 0; i4 < layer_4_p_fibers.size(); i4++)
        layer_4_p_fibers_d.push_back(double(layer_4_p_fibers[i4]));
  ...
  */
    ...
    if (layer_1_p_fibers_d.size() == 0) {
        ...
        printf(" |  LAYER 1  |     %5.2f    %2d   %8.3f  %8.3f     |     %5.2f    %2d   %8.3f  %8.3f     |\n",
               layer_1_p_fibers_d[0], n1_lowest_top[0], Z1_lowest_top[0], DZ1_lowest_top[0], layer_1_p_fibers_d[0],
               n1_lowest_bottom[0], Z1_lowest_bottom[0], DZ1_lowest_bottom[0]);
        for (unsigned int i1 = 0; i1 < DZ1_lowest_top.size() - 1; i1++) {
            printf(" |           |     %5.2f    %2d   %8.3f  %8.3f     |     %5.2f    %2d   %8.3f  %8.3f     |\n",
                   layer_1_p_fibers_d[i1 + 1], n1_lowest_top[i1 + 1], Z1_lowest_top[i1 + 1], DZ1_lowest_top[i1 + 1],
                   layer_1_p_fibers_d[i1 + 1], n1_lowest_bottom[i1 + 1], Z1_lowest_bottom[i1 + 1],
                   DZ1_lowest_bottom[i1 + 1]);
        }
    }
    ...
    if (layer_2_p_fibers_d.size() == 0) {
        ...
        printf(" |  LAYER 2  |     %5.2f    %2d   %8.3f  %8.3f     |     %5.2f    %2d   %8.3f  %8.3f     |\n",
               layer_2_p_fibers_d[0], n2_lowest_top[0], Z2_lowest_top[0], DZ2_lowest_top[0], layer_2_p_fibers_d[0],
               n2_lowest_bottom[0], Z2_lowest_bottom[0], DZ2_lowest_bottom[0]);
        for (unsigned int i2 = 0; i2 < DZ2_lowest_top.size() - 1; i2++) {
            printf(" |           |     %5.2f    %2d   %8.3f  %8.3f     |     %5.2f    %2d   %8.3f  %8.3f     |\n",
                   layer_2_p_fibers_d[i2 + 1], n2_lowest_top[i2 + 1], Z2_lowest_top[i2 + 1], DZ2_lowest_top[i2 + 1],
                   layer_2_p_fibers_d[i2 + 1], n2_lowest_bottom[i2 + 1], Z2_lowest_bottom[i2 + 1],
                   DZ2_lowest_bottom[i2 + 1]);
        }
    }
    ...
    if (layer_3_p_fibers_d.size() == 0) {
        ...
        printf(" |  LAYER 3  |     %5.2f    %2d   %8.3f  %8.3f     |     %5.2f    %2d   %8.3f  %8.3f     |\n",
               layer_3_p_fibers_d[0], n3_lowest_top[0], Z3_lowest_top[0], DZ3_lowest_top[0], layer_3_p_fibers_d[0],
               n3_lowest_bottom[0], Z3_lowest_bottom[0], DZ3_lowest_bottom[0]);
        for (unsigned int i3 = 0; i3 < DZ3_lowest_top.size() - 1; i3++) {
            printf(" |           |     %5.2f    %2d   %8.3f  %8.3f     |     %5.2f    %2d   %8.3f  %8.3f     |\n",
                   layer_3_p_fibers_d[i3 + 1], n3_lowest_top[i3 + 1], Z3_lowest_top[i3 + 1], DZ3_lowest_top[i3 + 1],
                   layer_3_p_fibers_d[i3 + 1], n3_lowest_bottom[i3 + 1], Z3_lowest_bottom[i3 + 1],
                   DZ3_lowest_bottom[i3 + 1]);
        }
    }
    ...
    if (layer_4_p_fibers_d.size() == 0) {
        ...
        printf(" |  LAYER 4  |     %5.2f    %2d   %8.3f  %8.3f     |     %5.2f    %2d   %8.3f  %8.3f     |\n",
               layer_4_p_fibers_d[0], n4_lowest_top[0], Z4_lowest_top[0], DZ4_lowest_top[0], layer_4_p_fibers_d[0],
               n4_lowest_bottom[0], Z4_lowest_bottom[0], DZ4_lowest_bottom[0]);
        for (unsigned int i4 = 0; i4 < DZ4_lowest_top.size() - 1; i4++) {
            printf(" |           |     %5.2f    %2d   %8.3f  %8.3f     |     %5.2f    %2d   %8.3f  %8.3f     |\n",
                   layer_4_p_fibers_d[i4 + 1], n4_lowest_top[i4 + 1], Z4_lowest_top[i4 + 1], DZ4_lowest_top[i4 + 1],
                   layer_4_p_fibers_d[i4 + 1], n4_lowest_bottom[i4 + 1], Z4_lowest_bottom[i4 + 1],
                   DZ4_lowest_bottom[i4 + 1]);
        }
    }
    ...
    std::vector<double> Z1_top;
    std::vector<double> Z1_bottom;
    std::vector<double> Z2_top;
    std::vector<double> Z2_bottom;
    std::vector<double> Z3_top;
    std::vector<double> Z3_bottom;
    std::vector<double> Z4_top;
    std::vector<double> Z4_bottom;

    std::vector<double> p1_top;
    std::vector<double> p1_bottom;
    std::vector<double> p2_top;
    std::vector<double> p2_bottom;
    std::vector<double> p3_top;
    std::vector<double> p3_bottom;
    std::vector<double> p4_top;
    std::vector<double> p4_bottom;

    std::vector<int> n1_top;
    std::vector<int> n1_bottom;
    std::vector<int> n2_top;
    std::vector<int> n2_bottom;
    std::vector<int> n3_top;
    std::vector<int> n3_bottom;
    std::vector<int> n4_top;
    std::vector<int> n4_bottom;

    std::vector<double> D_Z1_top;
    std::vector<double> D_Z1_bottom;
    std::vector<double> D_Z2_top;
    std::vector<double> D_Z2_bottom;
    std::vector<double> D_Z3_top;
    std::vector<double> D_Z3_bottom;
    std::vector<double> D_Z4_top;
    std::vector<double> D_Z4_bottom;
  ...
  */
    ...
    std::vector<double> Z_top_final;
    std::vector<double> Z_bottom_final;
    double DZ1_top_min = 999.;
    double DZ1_bottom_min = 999.;
    double DZ2_top_min = 999.;
    double DZ2_bottom_min = 999.;
    double DZ3_top_min = 999.;
    double DZ3_bottom_min = 999.;
    double DZ4_top_min = 999.;
    double DZ4_bottom_min = 999.;
    ...
    double Z_top_FINAL = 999.;
    double Z_bottom_FINAL = 999.;
    double DZ_top_FINAL = 999.;
    double DZ_bottom_FINAL = 999.;
    double sum_top = 0.;
    double sum_bottom = 0.;
...
std::vector<double> Batch_Ana3(double ADC_High_SFT_corr[128], int has_TDC_SFT_hit[128], int SFT_channel_to_fiber[128], double phi,
    ...
    double Z_top_FINAL = 999.99;
    double Z_bottom_FINAL = 999.99;
    double DZ_top_FINAL = 999.99;
    double DZ_bottom_FINAL = 999.99;
    double sum_top = 0.;
    double sum_bottom = 0.;
  ...
  */
    ...
    std::vector<double> Z_top_final;
    std::vector<double> Z_bottom_final;
    double DZ1_top_min = 999.99;
    double DZ1_bottom_min = 999.99;
    double DZ2_top_min = 999.99;
    double DZ2_bottom_min = 999.99;
    double DZ3_top_min = 999.99;
    double DZ3_bottom_min = 999.99;
    double DZ4_top_min = 999.99;
    double DZ4_bottom_min = 999.99;
